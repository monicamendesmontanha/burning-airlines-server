...
class AirplanesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create airplane" do
    assert_difference('Airplane.count') do
      post airplanes_url, params: { airplane: { column: @airplane.column, model: @airplane.model, row: @airplane.row } }
    end
  ...
  test "should update airplane" do
    patch airplane_url(@airplane), params: { airplane: { column: @airplane.column, model: @airplane.model, row: @airplane.row } }
